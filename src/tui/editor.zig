...
const KEYWORDS = [_][]const u8{
	...
	"CURRENT_TIME", "CURRENT_TIMESTAMP",   "DATABASE",   "DATE",      "DEFAULT",   "DEFERRABLE",
	"DELETE",      "DESC",     "DISTINCT",  "DO",        "DOUBLE",    "DROP",      "ELSE",
	"END",         "ESCAPE",   "EXCEPT",    "EXISTS",    "EXPLAIN",   "FALSE",     "FLOAT",
	"FOR",         "FOREIGN",  "FROM",      "FULL",      "GENERATED", "GRANT",     "GROUP",
	"HAVING",      "IF",       "IN",        "INDEX",     "INNER",     "INSERT",    "INT",
	"INTEGER",     "INTERSECT", "INTERVAL", "INTO",      "IS",        "JOIN",      "KEY",
	"LEFT",        "LIKE",     "LIMIT",     "MATERIALIZED", "NATURAL", "NOT",      "NOTHING",
	"NOTNULL",     "NULL",     "NULLS",     "NUMERIC",   "OFFSET",    "ON",        "OR",
	"ORDER",       "OUTER",    "OVER",      "PARTITION", "PRAGMA",    "PRIMARY",   "REAL",
	"REFERENCES",  "REINDEX",  "RENAME",    "REPLACE",   "RESTRICT",  "RETURNING", "RIGHT",
	"ROLLBACK",    "ROW",      "SAVEPOINT", "SELECT",    "SEQUENCE",  "SERIAL",    "SET",
	"SMALLINT",    "TABLE",    "TEMPORARY", "TEXT",      "THEN",      "TIMESTAMP", "TO",
	"TRANSACTION", "TRIGGER",  "TRUE",      "TRUNCATE",  "UNION",     "UNIQUE",    "UPDATE",
	"USING",       "VACUUM",   "VALUES",    "VARCHAR",   "VIEW",      "WHEN",      "WHERE",
	"WINDOW",      "WITH",     "WITHOUT",
};
