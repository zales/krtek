...
test "the connection string the portal hands out" {
	...
	const azure = try parse(arena,
		"DefaultEndpointsProtocol=https;AccountName=mystorage;AccountKey=abc==;EndpointSuffix=core.windows.net");
